...
# Title
st.markdown('<p class="title">Chest X-ray Tuberculosis Detection</p>', unsafe_allow_html=True)

# Additional information
st.markdown("""[For more information about Tuberculosis in India, visit - [tbcindia.mohfw.gov.in](https://tbcindia.mohfw.gov.in/)]""")
